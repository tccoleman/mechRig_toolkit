...
def set_override_color_UI():
    ...
    cmds.button(label="", bgc=(0.75, 0.75, 0.75), command = lambda *args:override_color(2))
    cmds.button(label="", bgc=(0.5, 0.5, 0.5), command = lambda *args:override_color(3))
    cmds.button(label="", bgc=(.8, 0, 0.2), command = lambda *args:override_color(4))
    cmds.button(label="", bgc=(0, 0, .4), command = lambda *args:override_color(5))
    cmds.button(label="", bgc=(0, 0, 1), command = lambda *args:override_color(6))
    cmds.button(label="", bgc=(0, .3, 0), command = lambda *args:override_color(7))
    cmds.button(label="", bgc=(0.2, 0, 0.3), command = lambda *args:override_color(8))
    cmds.button(label="", bgc=(.8, 0, .8), command = lambda *args:override_color(9))
    cmds.button(label="", bgc=(0.6, 0.3, 0.2), command = lambda *args:override_color(10))
    cmds.button(label="", bgc=(0.25, 0.13, 0.13), command = lambda *args:override_color(11))
    cmds.button(label="", bgc=(0.7, .2, 0), command = lambda *args:override_color(12))
    ...
    cmds.button(label="", bgc=(0, 1, .8), command = lambda *args:override_color(19))
    cmds.button(label="", bgc=(1, .7, .7), command = lambda *args:override_color(20))
    cmds.button(label="", bgc=(0.9, .7, .5), command = lambda *args:override_color(21))
    cmds.button(label="", bgc=(1, 1, 0.4), command = lambda *args:override_color(22))
    cmds.button(label="", bgc=(0, 0.7, .4), command = lambda *args:override_color(23))
    cmds.button(label="", bgc=(.6, .4, .2), command = lambda *args:override_color(24))
    cmds.button(label="", bgc=(.63, .63, .17), command = lambda *args:override_color(25))
    cmds.button(label="", bgc=(0.4, 0.6, 0.2), command = lambda *args:override_color(26))
    cmds.button(label="", bgc=(0.2, 0.63, 0.35), command = lambda *args:override_color(27))
    cmds.button(label="", bgc=(0.18, 0.63, 0.63), command = lambda *args:override_color(28))
    cmds.button(label="", bgc=(0.18, 0.4, 0.63), command = lambda *args:override_color(29))
    cmds.button(label="", bgc=(0.43, 0.18, 0.63), command = lambda *args:override_color(30))
    cmds.button(label="", bgc=(0.63, 0.18, 0.4), command = lambda *args:override_color(31))
